...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <!-- Cropping Patterns (Bar Chart) -->
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-xl font-semibold text-green-800 mb-4">
                    <i class="fas fa-seedling mr-2"></i>Cropping Patterns by Region
                </h2>
                <canvas id="croppingChart" height="150"></canvas>
            </div>

            <!-- Well Depths (Bar Chart) -->
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-xl font-semibold text-green-800 mb-4">
                    <i class="fas fa-tint mr-2"></i>Average Well Depth by Region
                </h2>
                <canvas id="wellsChart" height="150"></canvas>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        new Chart(croppingCtx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Cropping Patterns by Region'
                    }
                }
            }
        });
        ...
        // Well Depths (Bar Chart)
        const wellsCtx = document.getElementById('wellsChart').getContext('2d');
        new Chart(wellsCtx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($wells_labels); ?>,
                datasets: <?php echo json_encode($wells_datasets); ?>
            },
            options: {
                responsive: true,
                scales: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Average Well Depth by Region'
                    }
                }
            }
        });
